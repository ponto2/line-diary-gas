...
const TAGS = ["研究", "開発", "学習", "趣味", "健康", "お金", "食事", "外出", "写真", "その他"];
const MOODS = ["🤩", "😊", "😐", "😰", "😡"];
// 最新モデル優先リスト
...
- 趣味: 娯楽としての活動。小説（ミステリ・ホラー等）、映画鑑賞、ゲーム、ライブ・コンサート、音楽鑑賞など。
- 健康: 身体と心のメンテナンス。筋トレ、睡眠、体調管理、手術など。
- お金: 金銭に関わる記録すべて。金融資産（NISA・仮想通貨・貯金残高）、給料、ローン返済、物品の購入（ガジェット・本・服など）。
...
- 物品の購入（PC・本・服）も金融資産の売買（株・仮想通貨）もすべて "お金" タグを使うこと。
...
出力: {"title": "AirPods開封", "mood": "🤩", "tags": ["お金"]}
理由: 物品の購入記録
