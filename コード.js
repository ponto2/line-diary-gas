...
function sendWeeklyReview() {
  ...
  let reviewContext = "あなたはユーザーの生活背景を熟知した専属メンターAIです。以下の【ユーザー情報】と【日記ログ】を照らし合わせ、LINEで送るための週次レビューを作成してください。\n\n";

  reviewContext += "【👤 ユーザー情報（前提コンテキスト）】\n";
  reviewContext += userProfile + "\n\n";

  reviewContext += "【⚠️ 重要な制約事項】\n";
  reviewContext += "1. Markdownの太字記法（アスタリスク2つでの囲み）は絶対に使用禁止です。\n";
  reviewContext += "2. 見出しや強調には、絵文字や隅付き括弧【 】を使用してください。\n";
  reviewContext += "3. 全体で400文字〜500文字程度に収めてください。長すぎると読まれません。\n\n";

  reviewContext += "【レビュー構成】\n";
  reviewContext += "1. 🏆 今週のハイライト\n";
  reviewContext += "   - 具体的な行動や達成を拾って褒めちぎってください。\n";
  reviewContext += "2. 📊 感情と関心の分析\n";
  reviewContext += "   - 感情の浮き沈みや、何に時間を使ったかの傾向を客観的に伝えてください。\n";
  reviewContext += "3. 🚀 来週のアクションプラン\n";
  reviewContext += "   - 精神論ではなく、データに基づいた「来週こうするともっと良くなる」という具体的な行動を提案してください。\n\n";
